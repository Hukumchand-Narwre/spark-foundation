...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light  fixed-top">
        ...
        <div class="collapse navbar-collapse mobile-nav" id="navbarNavAltMarkup">
          <div class="navbar-nav ml-auto  align-items-center link-container">
            <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a>
            <a class="nav-link" href="coustomers.php">Coustomers</a>
            <a class="nav-link" href="sendmoney.php">Send money</a>
            <a class="nav-link" href="coustomerprofile.php">Profile</a>
